    ...
    render(){
       ...
       let optionItems = theatreList.map((val,i) =>
        <tr>
            ...
            <td><a href="#" title="Click to Add Details" onClick={this.handleRouteClick} id={val.id+'|details'}>{val.theater_name}</a></td>
            <td>{val.address}</td>
            ...
            <td>
                ...
                <a href={"addseat?"+val.id} title="Add Seats"><i className="fa fa-wheelchair"></i></a>&nbsp;&nbsp;
