              ...
              <form role="form" onSubmit={this.handleSubmit}  id="form-event">
                <div className="box-body">
                    ...
                    <div className="input-group">
                      <input type="text" class="form-control timepicker" id="title" name="title" value={this.state.title} onChange = { this.handleChange.bind(this)}/>
                    </div>
                    </div>
                    </div>
                    <div className="col-md-12">
                    ...
                    <div className="input-group">
                      <input type="text" class="form-control timepicker" id="embedUrl" name="embedUrl" value={this.state.url} onChange = { this.handleChange.bind(this)}/>
